  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto flex flex-col items-center lg:items-start opacity-0 animate-fade-in-up">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-5xl xl:text-6xl font-extrabold text-blue-950 leading-[1.2] lg:leading-[1.1] mb-4 tracking-tight text-center lg:text-left w-full">
          ...
          <p className="text-lg md:text-xl text-slate-600 mb-6 leading-relaxed text-balance text-center lg:text-left w-full">
          ...
          <p className="text-base md:text-lg text-slate-500 mb-8 leading-relaxed text-balance text-center lg:text-left w-full">
            ...
            mês, e valorizar seu imóvel com um ativo rentável.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 sm:gap-6 text-sm font-medium text-slate-600">
            ...
            <div className="flex items-center gap-3 bg-white/70 backdrop-blur px-4 py-2.5 rounded-xl border border-slate-200 shadow-sm">
